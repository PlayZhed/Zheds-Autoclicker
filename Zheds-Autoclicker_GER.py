...
lb_Input_coordinates = tk.Label(window,text='Koordinaten:',fg='darkblue')
lb_Input_coordinates.grid(row = 0,column = 1,sticky = 'we')

lb_Input_clicks = tk.Label(window,text='Wie viele Klicks:',fg='darkblue')
lb_Input_clicks.grid(row = 6,column = 1,sticky = 'we')

lb_Input_duration = tk.Label(window,text='Wie viele Sekunden:',fg='darkblue')
lb_Input_duration.grid(row = 8,column = 1,sticky = 'we')

lb_Input_Pause = tk.Label(window,text='Pause zwischen Klicks:',fg='darkblue')
...
#buttons
bt_start_amount = tk.Button(window,text='Start Anzahl',width = 30,fg = 'black',command = click_button_amount)
bt_start_amount.grid(row = 4,column = 1)

bt_start_duration = tk.Button(window,text='Start Dauer',width = 30,fg = 'black',command = click_button_duration)
bt_start_duration.grid(row = 4,column = 2)

bt_Transfer = tk.Button(window,text='Übertragen',width = 30,fg = 'black',command = transfer)
